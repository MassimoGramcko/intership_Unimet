  ...
  void _openSupportChat() async {
    ...
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        String adminName = "${adminData['firstName'] ?? ''} ${adminData['lastName'] ?? ''}".trim();
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppTheme.primaryOrange.withValues(alpha: 0.5), width: 2),
            ),
            child: CircleAvatar(
              radius: 50,
              backgroundColor: const Color(0xFF1E293B),
    ...
    return GestureDetector(
      ...
      child: ScaleTransition(
        ...
        child: AnimatedContainer(
          ...
          padding: const EdgeInsets.all(16),
          decoration: BoxDecoration(
            color: _isPressed ? const Color(0xFF2D3748) : const Color(0xFF1E293B),
            borderRadius: BorderRadius.circular(18),
            border: Border.all(
              color: _isPressed
          ...
          child: Row(
            children: [
              ...
              Icon(
                ...
                color: _isPressed ? Colors.white54 : Colors.white24,
                size: 14,
              ),
            ],
          ),
